...
function addCookie(name, value, options) {
	if (arguments.length > 1 && name != null) {
		...
		document.cookie = encodeURIComponent(String(name)) + "=" + encodeURIComponent(String(value)) + (options.expires ? "; expires=" + options.expires.toUTCString() : "") + (options.path ? "; path=" + options.path : "") + (options.domain ? "; com.domain=" + options.domain : ""), (options.secure ? "; secure" : "");
	}
}
